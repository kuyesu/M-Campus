...
import Image from '@/components/useable/Image';
import Text from '@/components/useable/Text';
import useTheme from '@/hooks/useTheme';
import Button from '@/components/useable/Button';
import Block from '@/components/useable/Block';
...
export default () => {
  ...
  const menu = {
    ...
    headerTitle: ({ children }: StackHeaderProps) => <Text p>{children}</Text>,
    headerLeft: () => (
